...
\begin{align}  \label{eq:rank-param}
...
\reffig{fig-eth-simu}表示了以太坊的市值与星云指数的关系，如图所示，二者的相关系数（Correlation coefficient）为0.84427,p值（p-value）为$4 \times{}10^{-17} < 0.001 $。说明函数~\ref{eq:rank}能够有效反映用户对整个经济体的贡献。
